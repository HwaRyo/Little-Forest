...
public class BookFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView book1_txt = root.findViewById(R.id.txtbook1);
                        ...
                        if (document.getBoolean("seed" + i)) {
                            if (i == 1) {
                                Glide.with(root.getContext())
                                        ...
                                        .into(book1);
                                book1_txt.setText("장미의 꽃말은 욕망, 열정, 기쁨, 아름다움, 결정 입니다.\n" +
                                ...
                                Glide.with(root.getContext())
                                        ...
                                        .into(book1);
                                book1_txt.setText("해바라기의 꽃말은 자부심입니다.\n" +
                                ...
                                Glide.with(root.getContext())
                                        ...
                                        .into(book1);
                                book1_txt.setText("코스모스의 꽃말을 아름다움, 질서, 평화, 온전함, 겸손함 입니다.\n" +
                                        "당신은 충분히 아름다워요.\n" +
