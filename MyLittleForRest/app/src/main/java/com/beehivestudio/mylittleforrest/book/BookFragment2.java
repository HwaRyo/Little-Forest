...
public class BookFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView book2_txt = root.findViewById(R.id.txtbook2);
                            ...
                            if(count==1) {
                                if (i == 1) {
                                    Glide.with(root.getContext())
                                            ...
                                            .into(book2);
                                    book2_txt.setText("장미의 꽃말은 욕망, 열정, 기쁨, 아름다움, 결정 입니다.\n" +
                                    ...
                                    Glide.with(root.getContext())
                                            ...
                                            .into(book2);
                                    book2_txt.setText("해바라기의 꽃말은 자부심입니다.\n" +
                                    ...
                                    Glide.with(root.getContext())
                                            ...
                                            .into(book2);
                                    book2_txt.setText("코스모스의 꽃말을 아름다움, 질서, 평화, 온전함, 겸손함 입니다.\n" +
                                            "당신은 충분히 아름다워요.\n" +
